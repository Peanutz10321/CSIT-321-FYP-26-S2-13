...
class User(Base):
    ...
    organized_elections = relationship("Election", back_populates="organizer")
    election_voter_records = relationship("ElectionVoter", back_populates="voter")
