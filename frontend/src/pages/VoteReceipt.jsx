      ...
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 space-y-5 text-sm text-slate-700">
            <div>
              <p className="font-semibold text-slate-900">Receipt Code</p>
            ...
            <div>
              <p className="font-semibold text-slate-900">Vote Hash</p>
              <p className="break-all font-mono text-xs text-slate-500">{vote.vote_hash}</p>
            </div>
          </div>
        </div>
